...
#                      net_arch = dict(vf=[256, 128], pi=[256, 128])) # new sb3: shared layers is not defined in net_arch here. 
# SAVE_FREQ = 1e8  # save frequency in timesteps: don't save model for now
# EP_TIMESTEPS = 128 # Number of steps per episode for training

# ########## Evaluation ##########
# EVAL_NUM_EPS = 1 # number of episodes for evaluation
# EVAL_INTERVAL = 1 # number of training rollout per evaluation (1 training rollout is BUFFER_SIZE_TRAINING samples)
# EP_TIMESTEPS_EVAL = 10000 # Number of steps per episode for evaluation
