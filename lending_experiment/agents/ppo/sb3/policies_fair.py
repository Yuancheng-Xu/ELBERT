...
Modification
Instead of one value function, 5 value function are used. 
...
class ActorCriticPolicy_fair(BasePolicy):
    ...
    def __init__(
        ...
        if self.share_features_extractor: # xyc
            ...
            self.vf_features_extractor_U_0 = self.features_extractor
            self.vf_features_extractor_B_0 = self.features_extractor
            self.vf_features_extractor_U_1 = self.features_extractor
            self.vf_features_extractor_B_1 = self.features_extractor
        else:
            self.pi_features_extractor = self.features_extractor

            self.vf_features_extractor = self.make_features_extractor()
            self.vf_features_extractor_U_0 = self.make_features_extractor()
            self.vf_features_extractor_B_0 = self.make_features_extractor()
            self.vf_features_extractor_U_1 = self.make_features_extractor()
            self.vf_features_extractor_B_1 = self.make_features_extractor()
    ...
    def _build_mlp_extractor(self) -> None:
        ...
        MlpExtractor_fair (defined in the next class): 5 value functions
        """
    ...
    def _build(self, lr_schedule: Schedule) -> None:
        ...
        self.value_net_U_0 = nn.Linear(self.mlp_extractor.latent_dim_vf, 1)
        self.value_net_B_0 = nn.Linear(self.mlp_extractor.latent_dim_vf, 1)
        self.value_net_U_1 = nn.Linear(self.mlp_extractor.latent_dim_vf, 1)
        self.value_net_B_1 = nn.Linear(self.mlp_extractor.latent_dim_vf, 1)
        ...
        if self.ortho_init:
            ...
            module_gains = {
                ...
                self.value_net: 1,
                self.value_net_U_0: 1,
                self.value_net_B_0: 1,
                self.value_net_U_1: 1,
                self.value_net_B_1: 1,
            }
            if not self.share_features_extractor:
                ...
                module_gains[self.vf_features_extractor_U_0] = np.sqrt(2)
                module_gains[self.vf_features_extractor_B_0] = np.sqrt(2)
                module_gains[self.vf_features_extractor_U_1] = np.sqrt(2)
                module_gains[self.vf_features_extractor_B_1] = np.sqrt(2)
    ...
    def forward(self, obs: th.Tensor, deterministic: bool = False) -> Tuple[th.Tensor, List[th.Tensor], th.Tensor]:
        ...
        if self.share_features_extractor:
            ...
            latent_vf, latent_vf_U_0, latent_vf_B_0, latent_vf_U_1, latent_vf_B_1 = tuple(latent_vf_all)
        else:
            pi_features, vf_features_all = features
            vf_features,vf_features_U_0,vf_features_B_0,vf_features_U_1,vf_features_B_1 = tuple(vf_features_all)
            latent_pi = self.mlp_extractor.forward_actor(pi_features)
            latent_vf = self.mlp_extractor.value_net(vf_features)
            latent_vf_U_0 = self.mlp_extractor.value_net_U_0(vf_features_U_0)
            latent_vf_B_0 = self.mlp_extractor.value_net_B_0(vf_features_B_0)
            latent_vf_U_1 = self.mlp_extractor.value_net_U_1(vf_features_U_1)
            latent_vf_B_1 = self.mlp_extractor.value_net_B_1(vf_features_B_1)
        
        # Evaluate the values for the given observations
        values = self.value_net(latent_vf)
        values_U_0 = self.value_net_U_0(latent_vf_U_0)
        values_B_0 = self.value_net_B_0(latent_vf_B_0)
        values_U_1 = self.value_net_U_1(latent_vf_U_1)
        values_B_1 = self.value_net_B_1(latent_vf_B_1)

        distribution = self._get_action_dist_from_latent(latent_pi)
        actions = distribution.get_actions(deterministic=deterministic)
        log_prob = distribution.log_prob(actions)
        actions = actions.reshape((-1, *self.action_space.shape))
        return actions, [values, values_U_0, values_B_0, values_U_1, values_B_1], log_prob
    ...
    def extract_features(self, obs: th.Tensor) -> Union[th.Tensor, Tuple[th.Tensor, List[th.Tensor]]]:
        ...
        if self.share_features_extractor:
            ...
            vf_features_U_0 = super().extract_features(obs, self.vf_features_extractor_U_0)
            vf_features_B_0 = super().extract_features(obs, self.vf_features_extractor_B_0)
            vf_features_U_1 = super().extract_features(obs, self.vf_features_extractor_U_1)
            vf_features_B_1 = super().extract_features(obs, self.vf_features_extractor_B_1)
            return pi_features, [vf_features,vf_features_U_0,vf_features_B_0,vf_features_U_1,vf_features_B_1]
    ...
    def evaluate_actions(self, obs: th.Tensor, actions: th.Tensor) -> Tuple[List[th.Tensor], th.Tensor, Optional[th.Tensor]]:
        ...
        return [values, values_U_0, values_B_0, values_U_1, values_B_1], log_prob, entropy
    ...
    def predict_values(self, obs: th.Tensor) -> List[th.Tensor]:
        ...
        features = self.extract_features(obs)
        if self.share_features_extractor:
            _, latent_vf_all = self.mlp_extractor(features) 
            latent_vf, latent_vf_U_0, latent_vf_B_0, latent_vf_U_1, latent_vf_B_1 = tuple(latent_vf_all)
        else:
            _, vf_features_all = features
            vf_features,vf_features_U_0,vf_features_B_0,vf_features_U_1,vf_features_B_1 = tuple(vf_features_all)
            latent_vf = self.mlp_extractor.value_net(vf_features)
            latent_vf_U_0 = self.mlp_extractor.value_net_U_0(vf_features_U_0)
            latent_vf_B_0 = self.mlp_extractor.value_net_B_0(vf_features_B_0)
        ...
        return [values, values_U_0, values_B_0, values_U_1, values_B_1]
    

class MlpExtractor_fair(nn.Module):
    """
    deal with 5 value functions r,r_U_0,r_B_0,r_U_1,r_B_1
    ...
    def __init__(
        ...
        value_net_U_0: List[nn.Module] = []
        value_net_B_0: List[nn.Module] = []
        value_net_U_1: List[nn.Module] = []
        value_net_B_1: List[nn.Module] = []
        ...
        for curr_layer_dim in vf_layers_dims:
            ...
            value_net_U_0.append(nn.Linear(last_layer_dim_vf, curr_layer_dim))
            value_net_U_0.append(activation_fn())

            value_net_B_0.append(nn.Linear(last_layer_dim_vf, curr_layer_dim))
            value_net_B_0.append(activation_fn())

            value_net_U_1.append(nn.Linear(last_layer_dim_vf, curr_layer_dim))
            value_net_U_1.append(activation_fn())

            value_net_B_1.append(nn.Linear(last_layer_dim_vf, curr_layer_dim))
            value_net_B_1.append(activation_fn())
        ...
        self.value_net_U_0 = nn.Sequential(*value_net_U_0).to(device)
        self.value_net_B_0 = nn.Sequential(*value_net_B_0).to(device)
        self.value_net_U_1 = nn.Sequential(*value_net_U_1).to(device)
        self.value_net_B_1 = nn.Sequential(*value_net_B_1).to(device)
    ...
    def forward_critic(self, features: th.Tensor) -> List[th.Tensor]:
        ...
        '''
        return [self.value_net(features), self.value_net_U_0(features), self.value_net_B_0(features), self.value_net_U_1(features), self.value_net_B_1(features)]
