...
from lending_experiment.config_auto import BETA_0, BETA_1, BETA_2, OMEGA
from lending_experiment.agents.ppo.sb3.on_policy_algorithm_auto import OnPolicyAlgorithm_auto
    ...
    def train(self) -> None:
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                if self.name=='A-PPO' or self.name=='A-PPO_app':
