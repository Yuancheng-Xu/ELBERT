...
CUDA_VISIBLE_DEVICES=0 python main_fair.py --seed 1 --modifedEnv --train_timesteps 5000000 --lr 1e-5 --bias_coef 0 --exp_path Chenghao_p_0.2_buffer5000_05_15/lr_1e-5_samples_5e6/b_0_s_1 &
CUDA_VISIBLE_DEVICES=1 python main_fair.py --seed 2 --modifedEnv --train_timesteps 5000000 --lr 1e-5 --bias_coef 0 --exp_path Chenghao_p_0.2_buffer5000_05_15/lr_1e-5_samples_5e6/b_0_s_2 
