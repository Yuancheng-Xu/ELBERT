...
from infectious_experiment.config_auto import REGULARIZE_ADVANTAGE, BETA_0, BETA_1, BETA_2, OMEGA
from infectious_experiment.agents.ppo.sb3.on_policy_algorithm_auto import OnPolicyAlgorithm_auto

# for auto eval
from infectious_experiment.environments.infectious_disease import Params

class PPO_auto(OnPolicyAlgorithm_auto):
    """
    ...
    def _setup_model(self) -> None:
        super(PPO_auto, self)._setup_model()
    ...
    def learn(
        ...
        return super(PPO_auto, self).learn(
