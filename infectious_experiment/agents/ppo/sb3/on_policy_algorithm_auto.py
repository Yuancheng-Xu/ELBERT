...
from infectious_experiment.agents.ppo.sb3.utils_auto import evaluate_auto
        ...
        while self.num_timesteps < total_timesteps:
            ...
            if self.eval_interval is not None and (iteration) % self.eval_interval == 0:
                ...
                if self.eval_env_name=='mod':
                    ...
                    env_eval = InfectiousDiseaseEnv(self.eval_env_params)
                # may need fix
                env_eval = PPOEnvWrapper_auto(env=env_eval, reward_fn=InfectiousReward, name=self.name, ep_timesteps=self.eval_timesteps)
