...
BUFFER_SIZE_TRAINING = 80 # only for training; for evaluation, the buffer_size = env.ep_timesteps, the number of steps in one episode

########## Evaluation ##########
EVAL_NUM_EPS = 100 # number of episodes for evaluation; Eric: 200
EVAL_INTERVAL = 125 # number of training rollout per evaluation (1 training rollout is BUFFER_SIZE_TRAINING samples)
