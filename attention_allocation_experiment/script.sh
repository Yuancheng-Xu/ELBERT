...
CUDA_VISIBLE_DEVICES=1 python main_fair.py --lr 1e-6 --beta_smooth 10 --bias_coef 10 --exp_path betaSmooth_10/lr_1e-6_samples_5e6_zeta0_0/b_10 &
CUDA_VISIBLE_DEVICES=2 python main_fair.py --lr 1e-6 --beta_smooth 10 --bias_coef 50 --exp_path betaSmooth_10/lr_1e-6_samples_5e6_zeta0_0/b_50 &
CUDA_VISIBLE_DEVICES=3 python main_fair.py --lr 1e-6 --beta_smooth 10 --bias_coef 100 --exp_path betaSmooth_10/lr_1e-6_samples_5e6_zeta0_0/b_100 &
CUDA_VISIBLE_DEVICES=4 python main_fair.py --lr 1e-6 --beta_smooth 10 --bias_coef 200 --exp_path betaSmooth_10/lr_1e-6_samples_5e6_zeta0_0/b_200 &
CUDA_VISIBLE_DEVICES=5 python main_fair.py --lr 1e-6 --beta_smooth 10 --bias_coef 500 --exp_path betaSmooth_10/lr_1e-6_samples_5e6_zeta0_0/b_500 &
CUDA_VISIBLE_DEVICES=6 python main_fair.py --lr 1e-6 --beta_smooth 10 --bias_coef 1000 --exp_path betaSmooth_10/lr_1e-6_samples_5e6_zeta0_0/b_1000 &
CUDA_VISIBLE_DEVICES=7 python main_fair.py --lr 1e-6 --beta_smooth 10 --bias_coef 2000 --exp_path betaSmooth_10/lr_1e-6_samples_5e6_zeta0_0/b_2000 
