...
CUDA_VISIBLE_DEVICES=3 python main_fair.py --modifedEnv --lr 1e-6 --beta_smooth 10 --bias_coef 200 --exp_path Chenghao_env_05_08/betaSmooth_10/lr_1e-6_samples_5e6/b_200 &

CUDA_VISIBLE_DEVICES=4 python main_fair.py --modifedEnv --lr 1e-6 --beta_smooth 1 --bias_coef 0.0 --exp_path Chenghao_env_05_08/betaSmooth_1/lr_1e-6_samples_5e6/b_0 &
CUDA_VISIBLE_DEVICES=5 python main_fair.py --modifedEnv --lr 1e-6 --beta_smooth 1 --bias_coef 10 --exp_path Chenghao_env_05_08/betaSmooth_1/lr_1e-6_samples_5e6/b_10 &
CUDA_VISIBLE_DEVICES=6 python main_fair.py --modifedEnv --lr 1e-6 --beta_smooth 1 --bias_coef 50 --exp_path Chenghao_env_05_08/betaSmooth_1/lr_1e-6_samples_5e6/b_50 &
CUDA_VISIBLE_DEVICES=7 python main_fair.py --modifedEnv --lr 1e-6 --beta_smooth 1 --bias_coef 200 --exp_path Chenghao_env_05_08/betaSmooth_1/lr_1e-6_samples_5e6/b_200 
